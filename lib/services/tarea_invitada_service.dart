...
class TareasInvitadasService {
  final String baseUrl = "http://192.168.100.38:9085/api/Tareas/invitaciones";
  ...
  Future<List<Tarea>> fetchTareasInvitadas({
    int rangoIni = 0,
    int rangoFin = 10,
  }) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception("Error al cargar tareas invitadas: ${response.body}");
      }
    } catch (e) {
      throw Exception("Error en fetchTareasInvitadas: $e");
    }
